...
<?php include './navigation.php'; ?>
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <input type="number" id="harga_perolehan" name="harga_perolehan" placeholder="Masukkan harga perolehan" >
        </div>

        <div class="form-group">
            <label for="harga_jual" class="form-label">Harga Jual</label>
            <input type="number" id="harga_jual" name="harga_jual" placeholder="Masukkan harga jual" >
        </div>

        <div class="form-group">
            <label for="jumlah_stok" class="form-label">Jumlah Stok</label>
            <input type="number" id="jumlah_stok" name="jumlah_stok" placeholder="Masukkan jumlah stok" >
        </div>
